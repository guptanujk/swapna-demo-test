...
// node_modules/pinia-plugin-persistedstate-2/dist/index.js
function A(s, e, f) {
...
function b(s) {
  ...
  function f(i) {
    ...
    if (c(true, "persist", n, e) === false) return;
    const a = c(i.store.$id, "key", n, {}), O = c(false, "overwrite", n, e), p = c(
      (function() {
        try {
